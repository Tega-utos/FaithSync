...
export function NotificationDropdown({
  ...
  const renderIcon = (type: NotificationItem['type'], icon_type?: string) => {
    if (icon_type === 'flame' || type === 'streak_milestone') {
      return <Fire size={16} weight="fill" className="text-[#234537]" />
    }
    if (icon_type === 'clock' || type === 'timer_invite') {
    ...
    if (type === 'buddy_request' || type === 'nudge') {
