      ...
      <div className="space-y-4">
        ...
        <div className="p-4 rounded-3xl bg-[#FAF6EE] border border-[#E5E7EB] space-y-2 shadow-2xs">
          ...
          <input
            ...
            className="w-full px-3.5 py-3 rounded-2xl bg-white border border-[#E5E7EB] text-xs font-bold text-[#0E0E0E] placeholder-[#9095A1] outline-none focus:border-[#FBBF24] focus:ring-2 focus:ring-[#FBBF24]/20 transition-all shadow-2xs"
          />
        </div>

        {/* 2. Daily Reminders Card */}
        <div className="p-4 rounded-3xl bg-[#FAF6EE] border border-[#E5E7EB] space-y-3.5 shadow-2xs">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="text-xs font-black text-[#0E0E0E]">Daily Reminders</h3>
                <p className="text-[10px] text-[#707070]">Gentle nudges to keep your streak</p>
              </div>
            </div>
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              />
              <div className="w-9 h-5 bg-[#E5E7EB] peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-[#FBBF24]" />
            </label>
          </div>
          ...
          {allowNotifications && (
            <div className="grid grid-cols-2 gap-2 pt-1 border-t border-[#E5E7EB]">
              <div className="space-y-1">
                <label className="text-[10px] font-bold text-[#707070] block">Morning Prayer</label>
                <div className="relative">
                  <input
                    type="time"
                    value={prayerReminderTime}
                    onChange={(e) => setPrayerReminderTime(e.target.value)}
                    className="w-full px-3 py-2 bg-white border border-[#E5E7EB] rounded-xl text-xs font-mono font-bold text-[#0E0E0E] shadow-2xs"
                  />
                </div>
              </div>

              <div className="space-y-1">
                <label className="text-[10px] font-bold text-[#707070] block">Evening Study</label>
                <div className="relative">
                  <input
                    type="time"
