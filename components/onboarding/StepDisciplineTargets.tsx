  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
      ...
      <div className="space-y-4">
        ...
        <div className="p-4 rounded-3xl bg-surface border border-border space-y-3 shadow-2xs">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[10px] text-text-secondary">Intentional communion</p>
              </div>
            </div>
            <span className="text-xs font-black font-mono-tabular text-text-primary bg-card px-2.5 py-1 rounded-xl border border-border shadow-2xs">
              {prayerTarget} min
            </span>
          </div>
        ...
        <div className="p-4 rounded-3xl bg-surface border border-border space-y-3 shadow-2xs">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="text-xs font-black text-text-primary">Scripture Study</h3>
                <p className="text-[10px] text-text-secondary">Deep reflection in the Word</p>
              </div>
            </div>
            <span className="text-xs font-black font-mono-tabular text-text-primary bg-card px-2.5 py-1 rounded-xl border border-border shadow-2xs">
              {studyTarget} min
      ...
      <button
        type="button"
        onClick={onNext}
        className="w-full py-4 px-6 rounded-2xl bg-[#FBBF24] text-text-primary font-black text-sm shadow-[0_4px_20px_rgba(251,191,36,0.25)] hover:bg-[#f5b318] active:scale-[0.98] transition-all flex items-center justify-center gap-2 cursor-pointer"
      >
        <span>Continue</span>
