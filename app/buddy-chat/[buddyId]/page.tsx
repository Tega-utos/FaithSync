...
export default function BuddyChatPage() {
  ...
  return (
    <div className="command-center-container flex flex-col min-h-screen min-h-[100dvh] h-screen h-[100dvh] max-h-[100dvh] bg-surface overflow-hidden">
      ...
      {toastMessage && (
        <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 px-4 py-2 rounded-full bg-[#0E0E0E] dark:bg-[#1E1B16] text-white dark:text-[#F5F1E8] border border-[#FBBF24]/50 dark:border-[#FBBF24]/50 shadow-xl text-xs font-bold flex items-center gap-2 animate-in slide-in-from-top duration-200">
          ...
          if (msg.message_type === 'system') {
            return (
              <div key={msg.id} className="w-full flex justify-center my-1.5">
                <span className="px-3.5 py-1.5 rounded-full bg-[#E5E7EB]/80 dark:bg-neutral-800 text-[10px] font-bold text-text-primary dark:text-neutral-200 border border-transparent dark:border-white/10 max-w-xs text-center shadow-xs">
                  {msg.content}
                </span>
              </div>
            )
      ...
      >
        ...
        <button
          ...
          className={`p-2.5 rounded-2xl transition-all shrink-0 ${
            inputContent.trim() && (!isSquareConnection || remainingSquareMessages > 0)
        ...
        >
          <div className="w-full max-w-sm bg-surface border border-border rounded-3xl p-5 space-y-4 shadow-2xl animate-in zoom-in-95">
            <div className="flex items-center justify-between pb-2 border-b border-border">
              <h3 className="text-sm font-extrabold text-text-primary">Send Picture</h3>
              <button
                type="button"
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="py-1.5 px-3 rounded-xl bg-card/10 hover:bg-rose-600 text-white font-bold text-xs flex items-center gap-1 transition-all cursor-pointer"
                >
                  <X size={16} />
                  <span>Exit</span>
                </button>
      ...
      {showEndConfirm && (
        <div className="fixed inset-0 z-60 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div className="w-full max-w-xs bg-surface border border-border rounded-3xl p-5 space-y-3 shadow-2xl text-center animate-in zoom-in-95">
            <h3 className="text-sm font-black text-text-primary">End Live Clock-In?</h3>
            ...
            <div className="grid grid-cols-2 gap-2 pt-2">
              <button
                ...
                className="py-2.5 px-3 rounded-xl bg-card border border-border text-xs font-bold text-text-secondary"
              >
                Keep Going
              </button>
              <button
                ...
                className="py-2.5 px-3 rounded-xl bg-[#0E0E0E] dark:bg-[#1E1B16] text-white dark:text-[#F5F1E8] border border-transparent dark:border-white/15 hover:bg-[#262626] dark:hover:bg-[#2A241C] text-xs font-bold transition-colors"
              >
                End & Save
              </button>
            </div>
