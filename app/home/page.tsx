...
export default function HomePage() {
  ...
  return (
    <div className="command-center-container px-4 sm:px-6 lg:px-8 pt-3 pb-28">
      ...
      {/* Adaptive Responsive 2-Column Dashboard Grid */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
        {/* Left Column: Weekly Progress, Momentum Rings & Clock-In CTA */}
