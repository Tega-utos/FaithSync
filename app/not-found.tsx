    ...
    <div className="min-h-screen min-h-[100dvh] bg-surface flex flex-col items-center justify-center px-6 py-12 text-center select-none">
      <div className="max-w-md w-full faith-card p-8 space-y-6 animate-fade-up">
        ...
        <div className="space-y-2">
          ...
          <h2 className="text-lg font-bold text-text-primary">Page Not Found</h2>
        ...
        <div className="pt-2 flex flex-col sm:flex-row gap-2.5 justify-center">
          ...
          <Link
            href="/welcome"
            className="px-5 py-3 rounded-2xl bg-subtle text-text-primary text-xs font-bold flex items-center justify-center gap-2 hover:bg-[#E5E7EB] transition-colors"
          >
