      ...
      <div className="flex-1 flex flex-col justify-start px-7 pt-6 pb-6 max-w-[420px] mx-auto w-full">
        ...
        <div className="space-y-3 relative z-20 animate-fade-up" style={{ animationDelay: '0.35s' }}>
          ...
          <Link href="/login" className="block w-full">
            <button
              type="button"
              className="w-full py-3.5 px-6 rounded-[30px] bg-transparent border-2 border-dashed border-[#FBBF24] text-text-primary font-black text-sm hover:bg-subtle active:scale-[0.98] transition-all cursor-pointer"
            >
